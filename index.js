// index.js — Render-Ready Roaming Bot
...
app.get('/', (req, res) => {
    ...
    res.send(`Bot is online. Uptime: ${uptime}`);
});
...
function handleDisconnect(reason) {
    ...
    if (reason === 'throttle') reconnectDelay = Math.max(reconnectDelay * 2, 60000);
